...
public class HourGridFridayActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> arrayEventNameFR = new ArrayList<String>();
    public static ArrayList<String> arrayStartTimeFR = new ArrayList<String>();
    public static ArrayList<String> arrayDurationTimeFR = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hour_grid_friday);
        ...
        arrayEventNameFR.add(eventName);
        arrayStartTimeFR.add(startTime);
        arrayDurationTimeFR.add(durationTime);

        for (int i = 0; i < (arrayEventNameFR.size()); i++){
            startTime = arrayStartTimeFR.get(i);
            durationTime = arrayDurationTimeFR.get(i);
            ...
            try {
                ...
                TextView secondText = new TextView(HourGridFridayActivity.this);
                ...
                secondText.setText(arrayEventNameFR.get(i));
                int[] opaqueColours = HourGridFridayActivity.this.getResources().getIntArray(R.array.opaqueColours);
                if (i < 10){
