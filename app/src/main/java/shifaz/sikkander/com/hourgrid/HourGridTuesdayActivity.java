...
public class HourGridTuesdayActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> arrayEventNameTU = new ArrayList<String>();
    public static ArrayList<String> arrayStartTimeTU = new ArrayList<String>();
    public static ArrayList<String> arrayDurationTimeTU = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hour_grid_tuesday);
        ...
        arrayEventNameTU.add(eventName);
        arrayStartTimeTU.add(startTime);
        arrayDurationTimeTU.add(durationTime);

        for (int i = 0; i < (arrayEventNameTU.size()); i++){
            startTime = arrayStartTimeTU.get(i);
            durationTime = arrayDurationTimeTU.get(i);
            ...
            try {
                ...
                TextView secondText = new TextView(HourGridTuesdayActivity.this);
                ...
                secondText.setText(arrayEventNameTU.get(i));
                int[] opaqueColours = HourGridTuesdayActivity.this.getResources().getIntArray(R.array.opaqueColours);
                if (i < 10){
