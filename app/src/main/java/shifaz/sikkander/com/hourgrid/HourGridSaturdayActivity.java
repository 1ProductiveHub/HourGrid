...
public class HourGridSaturdayActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> arrayEventNameSA = new ArrayList<String>();
    public static ArrayList<String> arrayStartTimeSA = new ArrayList<String>();
    public static ArrayList<String> arrayDurationTimeSA = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hour_grid_saturday);
        ...
        arrayEventNameSA.add(eventName);
        arrayStartTimeSA.add(startTime);
        arrayDurationTimeSA.add(durationTime);

        for (int i = 0; i < (arrayEventNameSA.size()); i++){
            startTime = arrayStartTimeSA.get(i);
            durationTime = arrayDurationTimeSA.get(i);
            ...
            try {
                ...
                TextView secondText = new TextView(HourGridSaturdayActivity.this);
                ...
                secondText.setText(arrayEventNameSA.get(i));
                int[] opaqueColours = HourGridSaturdayActivity.this.getResources().getIntArray(R.array.opaqueColours);
                if (i < 10){
