...
public class HourGridSundayActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> arrayEventNameSU = new ArrayList<String>();
    public static ArrayList<String> arrayStartTimeSU = new ArrayList<String>();
    public static ArrayList<String> arrayDurationTimeSU = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hour_grid_sunday);
        ...
        arrayEventNameSU.add(eventName);
        arrayStartTimeSU.add(startTime);
        arrayDurationTimeSU.add(durationTime);

        for (int i = 0; i < (arrayEventNameSU.size()); i++){
            startTime = arrayStartTimeSU.get(i);
            durationTime = arrayDurationTimeSU.get(i);
            ...
            try {
                ...
                TextView secondText = new TextView(HourGridSundayActivity.this);
                ...
                secondText.setText(arrayEventNameSU.get(i));
                int[] opaqueColours = HourGridSundayActivity.this.getResources().getIntArray(R.array.opaqueColours);
                if (i < 10){
